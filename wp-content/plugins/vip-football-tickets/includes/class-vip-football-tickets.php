...
class Vip_Football_Tickets {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Vip_Football_Tickets_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'VIP_FOOTBALL_TICKETS_VERSION' ) ) {
			$this->version = VIP_FOOTBALL_TICKETS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'vip-football-tickets';
	 ...
	 *
	 * - Vip_Football_Tickets_Loader. Orchestrates the hooks of the plugin.
	 * - Vip_Football_Tickets_i18n. Defines internationalization functionality.
	 * - Vip_Football_Tickets_Admin. Defines all hooks for the admin area.
	 * - Vip_Football_Tickets_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-vip-football-tickets-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-vip-football-tickets-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-vip-football-tickets-admin.php';

		/**
		 * the class responsible for show custom fields in listing table
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-vip-football-tickets-tables.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-vip-football-tickets-public.php';

		$this->loader = new Vip_Football_Tickets_Loader();
