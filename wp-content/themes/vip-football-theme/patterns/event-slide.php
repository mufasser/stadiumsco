<?php
/**
 * Title: List of event, slider
 * Slug: vip-football-theme/event-slide
 * Categories: query
 * Block Types: core/query
 */
?>
<div id="eventScrollContainer" class="flex flex-no-wrap overflow-x-scroll scrolling-touch items-start pb-8">
    <?php 
        $args = array(
            'post_type' => 'xs2_event',
            'posts_per_page' => 5,
